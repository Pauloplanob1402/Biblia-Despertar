...
export default function App() {
  const [activeSection, setActiveSection] = useState<'home' | 'bible' | 'devotionals' | 'profiles' | 'mesas' | 'ebooks' | 'profile' | 'respiro' | 'testemunhas' | 'primitiva' | 'apps' | 'mural' | 'apoiar' | 'mural-vivo' | 'faisca'>('home');
    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 flex flex-col md:flex-row antialiased selection:bg-[#C08261]/20">
            ...
            >
              ...
              <nav className="flex-1 p-4 space-y-1 overflow-y-auto w-full">
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-3 rounded-xl text-left text-sm font-semibold transition ${
                    ['mural','testemunhas','primitiva','profiles','mural-vivo','faisca'].includes(activeSection) ? 'bg-[#C08261]/10 text-[#C08261]' : 'text-stone-700 hover:bg-stone-50'
                  }`}
                >
                  <span className="flex items-center space-x-3">
                    <Compass size={15} />
      ...
      <aside className="hidden md:flex w-72 bg-white border-r border-stone-200/55 flex-col shrink-0 h-screen sticky top-0 z-30">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          {/* Sub-nav Comunidade */}
          {['mural','testemunhas','primitiva','profiles','mural-vivo','faisca'].includes(activeSection) && (
            <div className="ml-7 space-y-0.5 pb-1">
              {[
      ...
      >
        {([
          ...
          const active = activeSection === id ||
            (id === 'mural' && ['mural-vivo','faisca','testemunhas','primitiva','profiles'].includes(activeSection)) ||
