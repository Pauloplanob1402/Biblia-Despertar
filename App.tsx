    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 flex flex-col md:flex-row antialiased selection:bg-[#C08261]/20">
              ...
              <nav className="flex-1 p-4 space-y-1 overflow-y-auto w-full">
                ...
                <div className="ml-7 space-y-0.5 pb-1">
                  {[
                    ...
                    { id: 'faisca', label: 'Faíscas do Eterno' },
                    { id: 'mural-vivo', label: 'O Mural Vivo' },
      ...
      >
        {([
          ...
          { id: 'bible',   label: 'Palavra',     Icon: BookOpen },
          { id: 'mural',   label: 'Comunidade',  Icon: Users    },
          { id: 'mesas',   label: 'Mesas',       Icon: Coffee   },
          { id: 'profile', label: 'Perfil',      Icon: User     },
        ] as { id: typeof activeSection; label: string; Icon: React.ElementType }[]).map(({ id, label, Icon }) => {
