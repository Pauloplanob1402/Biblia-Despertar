  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto text-center">
      ...
      <div className="tabs-scroll-wrapper">
        <div className="tabs-scroll flex border-b border-stone-200 gap-1 justify-center select-none">
          <button
            onClick={() => setActiveSubTab('mesas')}
            className={`px-5 py-3 text-xs font-mono font-bold uppercase transition duration-200 border-b-2 tracking-wider whitespace-nowrap shrink-0 ${
              activeSubTab === 'mesas' 
        ...
        {activeSubTab === 'mesas' ? (
          ...
          >
            ...
            {mesasLoading ? (
              ...
              <div className="flex flex-col items-center justify-center gap-4 py-20 text-center border border-dashed border-stone-200 rounded-3xl">
                <Coffee size={48} color="#C08261" style={{ opacity: 0.4 }} />
                <h4 className="font-serif text-xl font-medium text-stone-800">Seja o primeiro</h4>
                <p className="text-sm text-stone-500 leading-relaxed max-w-xs mx-auto">
                  Nenhuma mesa por aqui ainda.<br />Abrir a sua leva 2 minutos.
                </p>
                <button
                  onClick={() => setShowCreateModal(true)}
                  className="bg-[#C08261] text-white rounded-2xl py-3 px-6 font-medium text-sm hover:bg-[#b07353] transition"
                >
                  + Inaugurar uma Mesa
                </button>
              </div>
                      ...
                      .map((p) => (
                        ...
                        >
                          <div className="flex items-start space-x-3">
                            <div className="w-12 h-12 p-1 shrink-0 bg-stone-50 rounded-2xl overflow-hidden flex items-center justify-center">
                              {p.photoURL
