 ...
 * Grupos online por temporada de vida. Sem encontros presenciais.
 * A tribo se forma pela dor compartilhada e pela fé que ancora.
 */
...
export default function MesasSection({ onStartChat, onOpenAuth, initialTab = 'mesas' }: MesasSectionProps) {
  ...
  const handleCriarTribo = async () => {
    ...
    try {
      ...
      setNovaTriboNome('');
      setNovaTriboTagline('');
      setNovaTriboDescricao('');
      setNovaTriboEmoji('🕊️');
      setShowCreateTribo(false);
      showNotification('Sua tribo foi criada 🕊️ Que ela floresça!');
    } catch (e) {
      console.error(e);
    } finally {
      setCriandoTribo(false);
    }
  };
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start gap-3 bg-[#fdfaf7] border border-[#C08261]/20 rounded-2xl px-4 py-3">
          ...
          <div>
            <p className="text-sm font-serif text-stone-700 italic leading-relaxed">
              "E os filhos de Israel acamparão cada um junto à sua bandeira,
              com as insígnias da casa de seus pais."
            </p>
            <span className="text-[10px] font-mono text-stone-400 mt-1 block">Números 2:2</span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="shrink-0 flex items-center gap-1.5 px-4 py-3 bg-stone-900 hover:bg-black text-white text-xs font-mono uppercase tracking-wider font-bold rounded-2xl transition min-h-[48px]"
            >
              <Sparkles size={13} />
          ...
          {/* Rodapé bíblico — substituiu a citação de Seth Godin */}
          <div className="text-center py-4 border-t border-stone-100 space-y-1">
            ...
            <p className="text-[10px] font-mono text-stone-400">Provérbios 27:17</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          {!currentUser ? (
            <div className="text-center py-12 space-y-4">
              ...
              <button
                onClick={onOpenAuth}
                className="px-6 py-3 bg-stone-900 hover:bg-black text-white text-xs font-mono uppercase tracking-wider font-bold rounded-2xl transition min-h-[48px]"
              >
                Entrar / Criar Conta
              </button>
            </div>
                  ...
                  {pilgrimsFiltrados.map((p, i) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 bg-stone-900 hover:bg-black text-white text-[10px] font-mono uppercase tracking-wider font-bold rounded-xl transition min-h-[48px]"
                      >
          ...
          <>
            ...
            >
              ...
              <div className="overflow-y-auto p-5 space-y-5" style={{ maxHeight: 'calc(85vh - 80px)' }}>
                <p className="text-sm text-stone-600 leading-relaxed">{triboSelecionada.descricao}</p>
        ...
        {showCreateTribo && (
          <>
            ...
            >
              <div className="flex items-center justify-between px-5 pt-5 pb-3 border-b border-stone-100">
                <div>
                  <h3 className="font-serif text-lg font-bold text-stone-800">Criar uma tribo</h3>
              ...
              <div className="overflow-y-auto p-5 space-y-4" style={{ maxHeight: 'calc(90vh - 80px)' }}>
                ...
                <div>
                  <label className="text-[10px] font-mono uppercase text-stone-400 font-bold tracking-wider block mb-2">
                    Escolha um emoji para sua tribo
                  </label>
                ...
                {/* Nome */}
                <div>
                  <label className="text-[10px] font-mono uppercase text-stone-400 font-bold tracking-wider block mb-1.5">
                    Nome da tribo *
                  </label>
                  <input
                    type="text"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-4 bg-stone-900 hover:bg-black disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-mono uppercase tracking-wider font-bold rounded-2xl transition shadow-sm min-h-[48px]"
                >
                  {criandoTribo ? (
