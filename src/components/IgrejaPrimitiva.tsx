...
export default function IgrejaPrimitiva({
  ...
  const [internalActiveTab, setInternalActiveTab] = useState<"comunhao" | "chamado" | "cocriacao">(
    "comunhao"
  );
  ...
  const setActiveTab = (tab: "comunhao" | "chamado" | "cocriacao") => {
  ...
  return (
    ...
    >
      ...
      {/* CORE VIEW TABS SELECTOR — oculto quando controlado externamente via hideTabsSelector */}
      {!hideTabsSelector && (
      <div className="tabs-scroll-wrapper">
        <div className="tabs-scroll flex border-b border-stone-200 gap-2">
          <button
