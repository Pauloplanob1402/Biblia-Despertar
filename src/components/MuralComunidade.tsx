  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto px-4 py-2">
      ...
      <div className="tabs-scroll-wrapper">
        <div className="tabs-scroll flex border-b border-stone-200/60 p-1 bg-stone-100/55 rounded-2xl md:max-w-md mx-auto md:mx-0 select-none">
          <button
            onClick={() => setActiveTab('pedidos')}
            className={`flex-1 py-2.5 px-3 rounded-xl text-xs font-mono uppercase font-black transition-all duration-300 whitespace-nowrap shrink-0 ${
              activeTab === 'pedidos' 
